...
public class Preference extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button backButton = (Button) findViewById(R.id.backPref);
        backButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent myIntent = new Intent(getBaseContext(), OBDMain.class);
    ...
    public static int getObdUpdatePeriod(SharedPreferences prefs) {
        String periodString = prefs.
                getString(Preference.OBD_UPDATE_PERIOD_KEY, "3"); // 4 as in seconds
        int period = 3000; // by default 4000ms
    ...
    public static int getGpsUpdatePeriod(SharedPreferences prefs) {
        String periodString = prefs
                .getString(Preference.GPS_UPDATE_PERIOD_KEY, "1"); // 1 as in seconds
    ...
    public static float getGpsDistanceUpdatePeriod(SharedPreferences prefs) {
        String periodString = prefs
                .getString(Preference.GPS_DISTANCE_PERIOD_KEY, "5"); // 5 as in meters
