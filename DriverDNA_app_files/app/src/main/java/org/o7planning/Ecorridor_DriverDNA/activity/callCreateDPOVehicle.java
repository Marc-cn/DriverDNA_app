...
public class callCreateDPOVehicle extends AsyncTask<Object, Void, String> {

    private static final String TAG = callCreateDPOVehicle.class.getName();
